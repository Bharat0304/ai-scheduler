...
MONGODB_URI = os.getenv('MONGODB_URI', "mongodb+srv://kbharat84265:SjgpL1UbSskmfFBO@cluster0.tfyruuc.mongodb.net/e-commerce?retryWrites=true&w=majority&appName=Cluster0")
